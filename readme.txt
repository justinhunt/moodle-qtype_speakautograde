============================================
The Speak (autograde) question type for Moodle >= 3.0
============================================

The speak (autograde) question type allows an speak question response to be given
...
============================================
    ...
    1. get the files for this plugin from any one of the following locations:
        ...
        (a) GIT: https://github.com/gbateson/moodle-qtype_speakautograde.git
        (b) zip: the Moodle.org -> Plugins repository (search for "speakautograde")
        (c) zip: https://bateson.kochi-tech.ac.jp/zip/plugins_qtype_speakautograde.zip

       If you are installing from a zip file, unzip the zip file, to create a folder
       called "speakautograde" and upload or move this folder into the "question/type" folder
       on your Moodle >= 3.0 site, to create a new folder at "question/type/speakautograde".
...
============================================
    ...
    https://github.com/gbateson/moodle-qtype_speakautograde
