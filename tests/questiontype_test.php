...
/**
 * Unit tests for the speakautograde question type class.
 *
 * @package    qtype
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_speakautograde_test extends advanced_testcase {
    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_speakautograde();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'speakautograde');
    }
