...
Each time one of the errors is found in the speak response, the specified penalty will be deducted from the student\'s grade for this question.';
...
$string['explanationgrade'] = 'Therefore, the computer-generated grade for this speak was set to {$a->finalgrade} = ({$a->finalpercent}% of {$a->maxgrade}).';
...
$string['explanationoverride'] = 'Later, {$a->datetime}, the grade for this speak was manually set to {$a->manualgrade}.';
...
$string['explanationrawpercent'] = 'The raw percentage grade for this speak is {$a->rawpercent}% <br /> = ({$a->details}).';
...
$string['itemcount_help'] = 'The minimum number of countable items that must be in the speak text in order to achieve the maximum grade for this question.
...
$string['itemtype_help'] = 'Select the type of items in the speak text that will contribute to the auto-grade.';
...
Thus, an speak in which many words are repeated has a low lexical density, while a speak with many unique words has a high lexical density.';
...
$string['responsesampleformat'] = 'Sample speak format';
...
$string['targetphrase_help'] = 'Specify the grade that will be added if this target phrase appears in the speak.
