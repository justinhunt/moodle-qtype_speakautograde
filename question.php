...
class qtype_speakautograde_question extends qtype_essayautograde_question {
    ...
    /**
     * Override "make_behaviour" method in the parent class, "qtype_speak_question",
     ...
     * @return qtype_speak_format_renderer_base the response-format-specific renderer.
     */
    public function get_format_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_speakautograde', 'format_' . $this->responseformat);
    }
